    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-120px)] p-6">
      <div className="max-w-xl w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-bold tracking-tight text-foreground">Create New Lesson</h1>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-background border-input focus:ring-ring focus:border-ring placeholder:text-muted-foreground/50 h-10"
                  required
                />
              </div>
              <div className="space-y-2">
                ...
                <Select defaultValue="intermediate" name="difficulty">
                  <SelectTrigger
                    id="difficulty"
                    className="w-full bg-background border-input focus:ring-ring focus:border-ring h-10"
                  >
              ...
              <div className="pt-4">
                <Button
                  className="w-full h-10 bg-primary text-primary-foreground hover:bg-primary/90 shadow-sm"
        ...
        {isGenerating && (
          <div className="text-center space-y-3 animate-pulse text-sm text-muted-foreground bg-muted/30 p-4 rounded-lg border border-border/50">
            <p className="font-medium text-foreground">Creating your lesson...</p>
